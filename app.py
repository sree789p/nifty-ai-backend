...
if hist.empty:
return {“price”: None, “change_pct”: None, “rsi”: None, “above_sma20”: None, “change_1w”: None}
...
total += 1
if len(last_10) < 10:
last_10.append({“date”: hist.index[i].strftime(”%Y-%m-%d”),
“predicted”: predicted, “actual”: actual,
“correct”: predicted == actual, “confidence”: round(score * 100, 1)})
...
“signal”: signal, “regime”: regime, “drivers”: drivers, “sparkline”: sparkline,
“market”: {“nifty”: market[“nifty”], “banknifty”: market[“banknifty”],
“nasdaq”: market[“nasdaq”], “nikkei”: market[“nikkei”],
“hangseng”: market[“hangseng”], “usd_inr”: market[“usd_inr”],
“crude”: market[“crude”], “india_vix”: market[“india_vix”]}})
except Exception as e:
traceback.print_exc()
...
ok, result = send_telegram(“✅ *Nifty AI v2.0 connected!*
15 signals | Asia | Backtest | Cache”)
if ok:
